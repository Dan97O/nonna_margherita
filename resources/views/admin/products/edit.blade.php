        ...
        <form action="{{ route('admin.products.update', $product->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId"
                    placeholder="product here " value="{{ $product->name }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="price" id="price" aria-describedby="helpId"
                    placeholder="" step="0.01" value="{{ $product->price }}">
            ...
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="in_stock" name="in_stock"
                    value="{{ $product->in_stock }}" checked>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="weight" id="weight" aria-describedby="helpId"
                    placeholder="" value="{{ $product->weight }}">
                <small id="helpId" class="form-text text-muted">Help text</small>
            </div>
            <div class="mb-3">
